...
from app.models.transactions import InputUTXO, OutputUTXO, Transaction, ProcessedTransaction


def process_utxos(inputs: List[InputUTXO], outputs: List[OutputUTXO]) -> List[Transaction]:
    transactions = group_transactions(inputs, outputs)
    processed_utxos = process_transactions(transactions)
